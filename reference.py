    ...
    try:
        ...
        if choice == '2':
            ...
            print(
                "-------------------------------------------------------------------------------------")
            print("\n")
            api = "https://api.viewdns.info/iphistory/?domain=" + \
                Domain+"&apikey="+key+"&output=json"
            ...
            openWeb = input(
                "Do You Want To Open GPS location in web broser? (Y/N) ")
            if openWeb.upper() == 'Y':
            ...
            print(
                "-------------------------------------------------------------------------------------")
            print("\n")
            api = "https://api.viewdns.info/traceroute/?domain=" + \
                Traceroute+"&apikey="+key+"&output=json"
            user_data = requests.get(api).json()
            pprint(user_data)
            ...
            print(
                "-------------------------------------------------------------------------------------")
            print("\n")
            api = "https://api.viewdns.info/freeemail/?domain=" + \
                Email+"&apikey="+key+"&output=json"
            user_data = requests.get(api).json()
            pprint(user_data)
            ...
            print(
                "-------------------------------------------------------------------------------------")
            print("\n")
            api = "https://api.viewdns.info/httpheaders/?domain=" + \
                http+"&apikey="+key+"&output=json"
            user_data = requests.get(api).json()
            pprint(user_data)
            ...
            Mailserver = input(
                "[+] Enter The Target Mailserver(e.g. mail.google.com) : ")
            print("Reverse MX Lookup results for", Mailserver)
            print(
                "-------------------------------------------------------------------------------------")
            print("\n")
            api = "https://api.viewdns.info/reversemx/?mx=" + \
                Mailserver+"&apikey="+key+"&output=json"
            user_data = requests.get(api).json()
            pprint(user_data)
            ...
            Nameserver = input(
                "[+] Enter The Target Nameserver(e.g. ns1.example.com) : ")
            print("Reverse NS Lookup results for", Nameserver)
            print(
                "-------------------------------------------------------------------------------------")
            print("\n")
            api = "https://api.viewdns.info/reversens/?ns=" + \
                Nameserver+"&apikey="+key+"&output=json"
            user_data = requests.get(api).json()
            pprint(user_data)
            ...
            print(
                "-------------------------------------------------------------------------------------")
            print("\n")
            api = "https://api.viewdns.info/reversedns/?ip=" + \
                rdns+"&apikey="+key+"&output=json"
            user_data = requests.get(api).json()
            pprint(user_data)
            ...
            print(
                "-------------------------------------------------------------------------------------")
            print("\n")
            api = "https://api.viewdns.info/portscan/?host=" + \
                port+"&apikey="+key+"&output=json"
            user_data = requests.get(api).json()
            pprint(user_data)
            ...
            print(
                "-------------------------------------------------------------------------------------")
            print("\n")
            api = "https://api.viewdns.info/dnsrecord/?domain=" + \
                Atype+"&recordtype=A&apikey="+key+"&output=json"
            user_data = requests.get(api).json()
            pprint(user_data)
            ...
            print("\n")
            api = "https://api.viewdns.info/dnsrecord/?domain=" + \
                Mxtype+"&recordtype=MX&apikey="+key+"&output=json"
            user_data = requests.get(api).json()
            pprint(user_data)
            ...
            print(
                "-------------------------------------------------------------------------------------")
            print("\n")
            api = "https://api.viewdns.info/propagation/?domain=" + \
                Dns+"&apikey="+key+"&output=json"
            user_data = requests.get(api).json()
            pprint(user_data)
            ...
            print(
                "-------------------------------------------------------------------------------------")
            print("\n")
            api = "https://api.viewdns.info/spamdblookup/?ip=" + \
                Spam+"&apikey="+key+"&output=json"
            user_data = requests.get(api).json()
            pprint(user_data)
            ...
            try:
                ...
                multipart = {'encoded_image': (
                    path, open(path, 'rb')), 'image_content': ''}
                response = requests.post(
                    url, files=multipart, allow_redirects=False)
